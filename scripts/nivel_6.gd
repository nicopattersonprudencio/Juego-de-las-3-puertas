...
func _ready():
	...
	if GameVariables.nivel_7_alcanzado:
		puerta.global_position = GameVariables.puertas_6[0]
		puerta2.global_position = GameVariables.puertas_6[1]
		puerta3.global_position = GameVariables.puertas_6[2]
	
	if GameVariables.escena_6_cambiada:
		jugador.global_position = puerta.global_position + Vector2(0, 30)
